...
void USART_IRQHandling(USART_Handle_t *pUSARTHandle)
{
    ...
    /* the status of ORE flag  in the SR */
    temp1 = pUSARTHandle->pUSARTx->SR & USART_SR_ORE;

    /* the status of RXNEIE  bit in the CR1 */
    temp2 = pUSARTHandle->pUSARTx->CR1 & USART_CR1_RXNEIE;

    if (temp1 && temp2)
    {
        /* Not to clear the ORE flag here, instead give an api for the application to clear the ORE flag */
